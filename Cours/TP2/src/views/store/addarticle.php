    ...
    <div class="mt-3 container d-flex justify-content-center">
        <form method="post" class="col-lg-6" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea type="text" class="form-control" name="desc" id="desc"><?= (isset($_POST['desc'])) ? $_POST['desc'] : '' ?></textarea>
            </div class="mb-3">
            <div class="mb-3">
                <label for="price" class="form-label">Prix</label>
                <input type="number" step="any" class="form-control" name="price" id="price" value="<?= (isset($_POST['price'])) ? $_POST['price'] : '2.00' ?>"/>
            </div>
            <div class="mb-3">
