...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <a class="btn btn-warning ms-auto mx-3" href="<?= HOME_PATH ?>/users/login">Se connecter</a>
</nav>
<div class="mh-100">
        ...
        <div class="mx-3 mt-3">
            ...
            <form method="post" class="col-lg-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" name="passconf" id="password" value="<?= (isset($_POST['passconf'])) ? $_POST['passconf'] : '' ?>"/>
                </div>
                <div class="mb-3">
